      ...
      <main className="flex-1 overflow-y-auto bg-bg">
        ...
        <div className="p-8">
          ...
          <div className="flex items-center justify-between mb-6">
            <h2 className="font-bebas text-2xl tracking-widest text-text">Member Management</h2>
          ...
          {/* Mini Stats */}
          <div className="flex gap-0 border border-border rounded-xl overflow-hidden mb-6">
            {miniStats.map((stat, idx) => (
              <div key={idx} className="flex-1 px-4.5 py-3.5 text-center border-r border-border last:border-r-0">
                <div className={`font-bebas text-2xl tracking-tight leading-none ${stat.color === 'success' ? 'text-success' : stat.color === 'accent2' ? 'text-accent2' : stat.color === 'accent3' ? 'text-accent3' : 'text-accent'}`}>
                  {stat.value}
                </div>
                <div className="text-9px text-muted font-mono uppercase tracking-tighter mt-1">{stat.label}</div>
              </div>
            ))}
          </div>

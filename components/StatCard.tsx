...
export default function StatCard({ label, value, change, changeType, color }: StatCardProps) {
  return (
    <div className="bg-surface border border-border rounded-xl p-5 relative overflow-hidden transition-colors hover:border-accent/30">
      ...
      <div className={`font-bebas text-5xl tracking-tight leading-none ${colorClasses[color].value}`}>{value}</div>
